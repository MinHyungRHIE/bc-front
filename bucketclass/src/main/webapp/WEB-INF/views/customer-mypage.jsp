...
<!--               <a href="index.html"><img src="/img/logo.png" alt=""></a>-->
               <a href="index.html" class="dashboard-logo"><img onclick="javascript:location.href='/';" src="/img/logo.png" alt=""></a>
            </div>
      ...
      <div class="row">
       ...
       <!--                  <div class="photoUpload">
                  ...
                  <div class="my-profile">
                     ...
                     <label>E-mail</label>
                     <input type="email" name= "memberEmail" id="memberEmail" placeholder="E-Mail 을 입력하세요" value="" onKeyUp="emailValidity(this.value)" />
                     <label id = "checkemail" class="check" ></label>

                     <label>자기소개</label>
                     <textarea name="introduce" id="introduce" cols="30" rows="10"  value=" " onKeyUp="checkByte(this.form, 500)"></textarea>
            ...
            <div class="dashboard-list-box margin-top-0">
               ...
               <div class="dashboard-list-box-static">
                  ...
                  <div class="my-profile">
                     ...
                     <input type="password" name=${memberPassword} id="memberPassword" placeholder="현재 비밀번호 입력"  />
...
<script type="text/javascript" src="/js/chosen.min.js"></script>W
