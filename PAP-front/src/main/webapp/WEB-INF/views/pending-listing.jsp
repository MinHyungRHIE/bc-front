...
<script>
    ...
    function templateDelete(serviceTemplateId){
        ...
        if(mock == false){
            var confirmUser = confirm("수업 목록을 정말 삭제하시겠습니까?");
            if(confirmUser){
    ...
    function showServiceItem(services) {
        ...
        for(service of services){
            ...
            serviceContent += '<li><div class="list-box-listing"><div class="list-box-listing-img">'
                +'<a href="" onclick="templateReadOnly(service.serviceTemplateId);"><img src="'+service.serviceImgUri+'" alt=""></a></div>'
                ...
                +'<a href="" class="button gray" onclick="templateRegist(service);"><i class="sl sl-icon-action-redo"></i> 등록</a>'
                +'<a href="" class="button gray" onclick="templateEdit(service.serviceTemplateId);"><i class="sl sl-icon-note"></i> 수정</a>'
                +'<a href="" class="button gray" onclick="templateDelete(service.serviceTemplateId);"><i class="sl sl-icon-close"></i> 삭제</a></div></li>'
        }
