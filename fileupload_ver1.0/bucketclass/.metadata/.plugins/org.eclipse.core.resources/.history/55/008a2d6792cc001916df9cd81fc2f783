...
<head>
	...
	<!-- Basic Page Needs
    ================================================== -->
	<title>BucketClass-User-profile</title>
	<meta charset="utf-8">
			...
			<div class="container">
				...
				<div class="left-side">
					...
					<div id="logo">
						...
						<a href="/" class="dashboard-logo"><img src="/img/logo.png" alt=""></a>
					</div>
						...
						<ul id="responsive">
							...
							<li><a class="current" href="#">User Panel</a>
								<ul>
									...
									<li><a href="provider-mypage.html">마이페이지</a></li>
		...
		<div class="dashboard-nav">
			<div class="dashboard-nav-inner">
				...
				<ul data-submenu-title="Listings">
					...
					<li><a id="sideBarBookmarks"><i class="sl sl-icon-heart"></i> Bookmarks</a></li>
				...
				<ul data-submenu-title="">
					...
					<li><a href="/logout" id="sideBarLogout"><i class="sl sl-icon-power"></i> Logout</a></li>
				</ul>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="dashboard-list-box margin-top-0">
						...
						<div class="col-fs-6" align="" style="color:#c8c8c8; font-size:0.8em">가입일 : <span id="memberJoinDate" style="color:#c8c8c8"></span></div>
						<div class="dashboard-list-box-static">
							...
							<div class="my-profile">
								...
								<label>자기소개</label>
								<textarea name="introduce" id="introduce" cols="30" rows="10" onKeyUp="checkByte(this.form, 500)"><?=$introduce?></textarea>
					...
					<div class="dashboard-list-box margin-top-0">
						...
						<div class="dashboard-list-box-static">
							...
							<div class="my-profile">
								...
								<label>새 비밀번호</label>
								<input type="password" name="newPassword" id="newPassword" value="" placeholder="새 비밀번호 입력" onkeyup="newPwValidity(this.value)" />
								<label id="new-pw-notify"></label>

								<label>새 비밀번호 확인</label>
								<input type="password" name="checkPassword" id="checkPassword" value="" placeholder="새 비밀번호 확인" onkeyup="confirmPwValidity(this.value)" />
...
<script type="text/javascript" src="/js/customer-profile.js"></script>
