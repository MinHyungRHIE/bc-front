   ...
   <div class="container">
      <div class="row" >
         <div class="col-md-12">
            ...
            <h2>원하는 수업을 찾아보세요!</h2><span style="display:none">Grid Layout With Sidebar</span>
               ...
               <div class="fullwidth-filters">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div style="margin-bottom: 25px">
                                 ...
                                 <label for="check-a">체험</label>
                                 <input id="check-b" type="checkbox" name="check">
                                 <label for="check-b">교육</label>
                              </div>
                              <div>
                                 <h4>기간</h4>
                                 <input id="check-c" type="checkbox" name="check">
                                 <label for="check-c">정기</label>
                                 <input id="check-d" type="checkbox" name="check">
                                 <label for="check-d">비정기</label>
                              </div>
                           </div>
                           ...
                           <div class="col-md-6">
                              <div style="margin-bottom: 25px">
                                 ...
                                 <label for="check-e">개인(1:1)</label>
                                 <input id="check-f" type="checkbox" name="check" >
                                 <label for="check-f">그룹(1:N)</label>
                              </div>
                              <div>
                                 <h4>장소</h4>
                                 <input id="check-g" type="checkbox" name="check" >
                                 <label for="check-g">실내</label>
                                 <input id="check-h" type="checkbox" name="check" >
                                 <label for="check-h">실외</label>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="sort-by">
                     <div class="sort-by-select">
                        <select data-placeholder="검색 타입(전체)" class="chosen-select-no-single">
