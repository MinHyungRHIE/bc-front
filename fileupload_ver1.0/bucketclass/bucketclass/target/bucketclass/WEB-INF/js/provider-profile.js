...
function button_myprofile(){
    ...
    if(checkAll() === true){
        ...
        //patchRequest('/provider/mypage/update', object);
        Apis.updateProviderProfile(providerMypageObject).then(response => {
...
//저장하는 POST로 fetch!->Formdata가 object가 됨.
document.getElementById("saveBtn").addEventListener("click", updateImg);
function updateImg(){
