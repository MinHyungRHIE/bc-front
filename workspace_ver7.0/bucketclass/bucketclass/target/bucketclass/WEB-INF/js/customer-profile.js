...
$(document).ready(function () {
    ...
    Apis.postRequest('/customer/mypage',unmeaningFulData).then(response => {
        ...
        insertText('memberJoinDate', response.memberJoinDate);
    });
...
function button_myprofile(){
    ...
    if(checkAll() === true) {
        ...
        myForm.addEventListener('submit', function (e) {
            ...
            if (imgFormData.get('memberImg') == 'undefined') {
                const obj1 = Object.fromEntries(imgFormData);
                console.log('obj1', obj1);

                imgFormData.delete('memberImg');
                const obj2 = Object.fromEntries(imgFormData);
                console.log('obj2', obj2);

                imgFormData.append('memberImg', document.getElementById('memberImg').src.substring(26,));
                const obj3 = Object.fromEntries(imgFormData);
