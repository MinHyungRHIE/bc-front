...
<body>
    ...
    ================================================== -->
				...
				<div class="container">
								...
								<li><a href="#">Listings</a>
									<ul>
										<li><a href="#">List Layout</a>
											<ul>
												<li><a href="listings-list-with-sidebar.html">With
														Sidebar</a></li>
												<li><a href="listings-list-full-width.html">Full
														Width</a></li>
												<li><a href="listings-list-full-width-with-map.html">Full
														Width + Map</a></li>
											</ul></li>
										<li><a href="#">Grid Layout</a>
											<ul>
												<li><a href="listings-grid-with-sidebar-1.html">With
														Sidebar 1</a></li>
												<li><a href="listings-grid-with-sidebar-2.html">With
														Sidebar 2</a></li>
												<li><a href="listings-grid-full-width.html">Full
														Width</a></li>
												<li><a href="listings-grid-full-width-with-map.html">Full
														Width + Map</a></li>
											</ul></li>
										<li><a href="#">Half Screen Map</a>
											<ul>
												<li><a href="listings-half-screen-map-list.html">List
														Layout</a></li>
												<li><a href="listings-half-screen-map-grid-1.html">Grid
														Layout 1</a></li>
												<li><a href="listings-half-screen-map-grid-2.html">Grid
														Layout 2</a></li>
											</ul></li>
										<li><a href="#">Single Listings</a>
											<ul>
												<li><a href="listings-single-page.html">Single
														Listing 1</a></li>
												<li><a href="listings-single-page-2.html">Single
														Listing 2</a></li>
												<li><a href="listings-single-page-3.html">Single
														Listing 3</a></li>
											</ul></li>
									</ul></li>
									...
									<div class="mega-menu mobile-styles three-columns">
										...
										<div class="mega-menu-section">
											<ul>
												...
												<li><a href="pages-user-profile.html"><i
														class="sl sl-icon-user"></i> User Profile</a></li>
												<li><a href="pages-booking.html"><i
														class="sl sl-icon-check"></i> Booking Page</a></li>
												<li><a href="pages-add-listing.html"><i
														class="sl sl-icon-plus"></i> Add Listing</a></li>
												<li><a href="pages-blog.html"><i
														class="sl sl-icon-docs"></i> Blog</a></li>
											</ul>
										</div>
										...
										<div class="mega-menu-section">
											<ul>
												...
												<li><a href="pages-404.html"><i
														class="sl sl-icon-close"></i> 404 Page</a></li>
										...
										<div class="mega-menu-section">
											<ul>
												...
												<li><a href="pages-elements.html"><i
														class="sl sl-icon-settings"></i> Elements</a></li>
												<li><a href="pages-pricing-tables.html"><i
														class="sl sl-icon-tag"></i> Pricing Tables</a></li>
												<li><a href="pages-typography.html"><i
														class="sl sl-icon-pencil"></i> Typography</a></li>
												<li><a href="pages-icons.html"><i
														class="sl sl-icon-diamond"></i> Icons</a></li>
											</ul>
										</div>
					...
					<div class="right-side">
						...
						<div class="header-widget">
							...
							<div class="user-menu">
								<div class="user-name">
									<span><img src="/img/dashboard-avatar.jpg" alt=""></span>Hi,
									Tom!
								</div>
								<ul>
									...
									<li><a href="index.html"><i class="sl sl-icon-power"></i>
											Logout</a></li>
								</ul>
							</div>

							<a href="dashboard-add-listing.html"
								class="button border with-icon">Add Listing <i
				...
				<div class="dashboard-nav-inner">
					...
					<ul data-submenu-title="Main">
						<li><a href="dashboard.html"><i
								class="sl sl-icon-settings"></i> Dashboard</a></li>
						<li><a href="dashboard-messages.html"><i
								class="sl sl-icon-envelope-open"></i> Messages <span
								class="nav-tag messages">2</span></a></li>
						<li><a href="dashboard-bookings.html"><i
								class="fa fa-calendar-check-o"></i> Bookings</a></li>
						<li><a href="dashboard-wallet.html"><i
					...
					<ul data-submenu-title="Listings">
						<li><a><i class="sl sl-icon-layers"></i> My Listings</a>
							<ul>
								<li><a href="dashboard-my-listings.html">Active <span
										class="nav-tag green">6</span></a></li>
								<li><a href="dashboard-my-listings.html">Pending <span
										class="nav-tag yellow">1</span></a></li>
								<li><a href="dashboard-my-listings.html">Expired <span
										class="nav-tag red">2</span></a></li>
							</ul></li>
						<li><a href="dashboard-reviews.html"><i
								class="sl sl-icon-star"></i> Reviews</a></li>
						<li><a href="dashboard-bookmarks.html"><i
								class="sl sl-icon-heart"></i> Bookmarks</a></li>
						<li class="active"><a href="dashboard-add-listing.html"><i
								class="sl sl-icon-plus"></i> Add Listing</a></li>
					</ul>

					<ul data-submenu-title="Account">
						<li><a href="dashboard-my-profile.html"><i
        ...
        ================================================== -->
			<div class="dashboard-content">
				...
				<div class="add-listing-section margin-top-45">
					...
					<div class="add-listing-headline">
						<h3>
							<i class="sl sl-icon-book-open"></i> 수업 정지
						</h3>
						<!-- Switcher -->
						<label class="switch"><input type="checkbox" id="isActive"
						...
						<div class="col-lg-12">
							...
							<div id="add-listing">
								...
								<div class="add-listing-section">
									...
									<div class="add-listing-headline">
										<h3>
											<i class="sl sl-icon-doc"></i> 기본 정보
										</h3>
									</div>
									...
									<div class="row with-forms">
										<div class="col-md-12">
											...
											<h5>
												수업명 <i class="tip" data-tip-content="제공하실 수업명을 입력하세요."></i>
											</h5>
									...
									<div class="row with-forms">
										...
										<div class="col-md-6">
											...
											<div class="panel-dropdown wide float-left">
												<i class="tip" data-tip-content="선택사항 입니다."></i><a href="#">카테고리
													상세 지정</a>
													...
													<div class="row">
														<div class="col-md-6">
															<div style="margin-bottom: 25px">
																...
																<label for="check-a1">체험</label> <input id="check-b1"
																	type="checkbox" name="check"> <label
																	for="check-b1">교육</label>
															</div>
															<div>
																<h4>기간</h4>
																<input id="check-c1" type="checkbox" name="check">
																<label for="check-c1">정기</label> <input id="check-d1"
																	type="checkbox" name="check"> <label
																	for="check-d1">비정기</label>
															</div>
														</div>
														...
														<div class="col-md-6">
															<div style="margin-bottom: 25px">
																...
																<label for="check-e1">개인(1:1)</label> <input
																	id="check-f1" type="checkbox" name="check"> <label
																	for="check-f1">그룹(1:N)</label>
															</div>
															<div>
																<h4>장소</h4>
																<input id="check-g1" type="checkbox" name="check">
																<label for="check-g1">실내</label> <input id="check-h1"
																	type="checkbox" name="check"> <label
																	for="check-h1">실외</label>
															</div>
														</div>
													</div>
										...
										<div class="col-md-6">
											<h5>
												해시테그 <i class="tip" data-tip-content="최대 5개의 해시테그를 선택하세요"></i>
											</h5>
								...
								<div class="add-listing-section margin-top-45">
									...
									<div class="add-listing-headline">
										<h3>
											<i class="sl sl-icon-docs"></i> 수업 설명<i class="tip"
												data-tip-content="게스트가 참여하게 될 이벤트 활동을 구체적으로 설명하세요."></i>
										</h3>
									...
									<div class="form">
										<h5>
											수업 소개<i class="tip"
												data-tip-content="수업을 처음부터 끝까지 실제 진행 순서대로 설명해 주세요."></i>
										</h5>
										<textarea class="WYSIWYG" name="summary" cols="40" rows="3"
											id="summary" spellcheck="true"
											placeholder="각 활동에 대한 설명을 실제 진행 순서대로 써주세요."></textarea>
									</div>
								...
								<div class="add-listing-section margin-top-45">
									...
									<div class="add-listing-headline">
										<h3>
											<i class="sl sl-icon-picture"></i> 사진
										</h3>
									</div>
								...
								<div class="add-listing-section margin-top-45">
									...
									<div class="add-listing-headline">
										<h3>
											<i class="sl sl-icon-book-open"></i> 계좌정보
										</h3>
										<!-- Switcher -->
									...
									<div class="row">
										<div class="col-md-12">
											<table id="pricing-list-container">
												<tr class="pricing-list-item pattern">
													<td>
														...
														<div class="col-md-5">
															<select class="chosen-select" data-placeholder="은행명"
																id="chosen-select">
														...
														<div class="col-md-5">
															<div class="fm-input pricing-ingredients">
																<input type="int" placeholder="계좌번호" id="account_num" />
															</div>
														</div>
														<div class="fm-close">
											...
											<a href="#" class="button add-pricing-list-item">은행 및 계좌
												추가</a>
										</div>
									</div>
							...
							<div class="add-listing-section margin-top-45">
								...
								<div class="add-listing-headline">
									<h3>
										<i class="im im-icon-Calendar-Clock"></i> 달력날짜입력
									</h3>
								</div>
									...
									<div class="row with-forms">
										...
										<div class="col-md-12">
											...
											<div>
												<p>검색 요령</p>
												<ul>
													<li>도로명주소 검색 : 도로명과 건물번호를 입력하세요. 예: <span>세종대로
															110</span></li>
													<li>지번주소 검색 : "동" 또는 "리" 이름과 번지수를 입력하세요. 예: <span>연산동
															1000</span></li>
													<li>건물명 검색 : 빌딩 또는 아파트 이름을 입력하세요. 예: <span>방배동
															래미안</span>, <span>수곡동 주공3차</span></li>
			...
			<!-- Content / End -->
			<a class="button save" id="button save" onclick="combineJson()">저장하기<i
...
================================================== -->
    ...
    console.log("ok : 들어왔어", sendJson);

        // 수정되것지?/provider/my-listing/{serviceId}/update
        putRequest('/provider/my-listing/'+serviceId+'/update',  sendJson).then(response => {
    ...
    window.onload = function(){
        ...
        //test 진행 중
            ...
            $(document).ready(function () {
                ...
                console.log("Apis 직전");
                Apis.postRequest('/provider/my-listing/'+serviceid+'/update',unmeaningFulData).then(response => {
