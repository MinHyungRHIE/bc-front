					...
					<ul id="responsive">
						...
						<li><a class="current" href="#">User Panel</a>
							<ul>
								...
								<li><a href="/provider/mypage">My Profile</a></li>
							...
							<div class="mega-menu mobile-styles three-columns">
									...
									<div class="mega-menu-section">
										<ul>
											...
											<li><a href="pages-profile.html"><i class="sl sl-icon-user"></i> User Profile</a></li>
	...
	<div class="dashboard-nav">
		<div class="dashboard-nav-inner">
			...
			<ul data-submenu-title="Account">
				<li><a href="/provider/mypage"><i class="sl sl-icon-user"></i> My Profile</a></li>
