					...
					<div class="right-side">
						<div class="header-widget">
							<a href="#sign-in-dialog" class="sign-in popup-with-zoom-anim"><i
								class="sl sl-icon-login"></i> Sign In</a> <a
								...
								<div class="tab-content" id="tab1" style="display: none;">
									<form method="post" class="login">
										...
										<p class="form-row form-row-wide">
											...
											</label> <span class="lost_password"> <a href="#">Lost
													Your Password?</a>
											</span>
										</p>
									...
									<form method="post" class="register">
										...
										<p class="form-row form-row-wide">
											<label for="email2">Email Address: <i
												class="im im-icon-Mail"></i> <input type="text"
...
/*     		$(document).ready(function () {
   ...
   function showServiceItem(services) {
      ...
      for(var service of services){
    	         ...
    	         serviceContent += '<div class="col-lg-12 col-md-12">'
    	               +'<div class="listing-item-container list-layout" onclick="viewSingleService(service.serviceId);">'
    	               +'<a class="listing-item"><div class="listing-item-image"><img src="'+service.serviceImgUri+'">'
   ...
   function searchHandler(){
      ...
      console.log(serviceTitle, categoryVal,
            categoryType, categoryPeriod, categoryScale, categoryPlace);
   ...
   function paginationRequest(page) {
      ...
      Apis.getRequest(`/service-listing/`+page).then(response =>{
         showServiceItem(response.items);
         resetPagination(response.page, response.size, response.totalCount);
      })
